class TheTradeAdmin::BuyersController < TheTradeAdmin::BaseController
  ...
  def index
    ...
    q_params = params.fetch(:q, {}).permit(:payment_strategy_id, :'crm_permits.manager_id', :'name-like',  :compliant).reverse_merge('orders.payment_status': ['unpaid', 'part_paid'], 'orders.state': 'active')
